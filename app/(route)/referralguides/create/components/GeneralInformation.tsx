...
import { SelectCustomer, SelectOption, Separate, TextInput } from '@/components';
...
export const GeneralInformation = () => {
	...
	const { optionPoints, handleChange, handleSelectPoint, handleSelectCustomer } =
					...
					<div className='w-full'>
						...
						{points.length > 1 && (
							<div className='flex flex-col lg:w-2/3'>
								<SelectOption
									label='Punto Emisión'
									name='emision_point_id'
									options={optionPoints}
									select={true}
									selectedValue={selectPoint?.id ?? ''}
									error={errors.serie}
						...
						<div className='lg:w-2/3'>
							<TextInput
								...
								value={referralGuide.address_from}
						...
						<div className='lg:w-2/3'>
							<TextInput
								...
								value={referralGuide.address_to}
					...
					<div className='w-full'>
						<div className='lg:w-2/3'>
							<TextInput
								type='date'
								label='Fecha inicio *'
								value={referralGuide.date_start}
						...
						<div className='lg:w-2/3'>
							<TextInput
								...
								value={referralGuide.reason_transfer}
								error={errors.reason_transfer}
								onChange={handleChange}
						...
						<div className='lg:w-2/3'>
							<TextInput
								type='text'
								label='Cod estable destino'
								value={referralGuide.branch_destiny ?? ''}
								error={errors.branch_destiny}
								onChange={handleChange}
								name='branch_destiny'
								maxLength={3}
							/>
						...
						<div className='lg:w-2/3'>
							<TextInput
								...
								value={referralGuide.customs_doc ?? ''}
								error={errors.customs_doc}
								onChange={handleChange}
								name='customs_doc'
								maxLength={17}
							/>
				...
				<div className='sm:flex gap-4'>
					...
					<div className='w-full'>
						<TextInput
							type='text'
							label='Serie'
							value={referralGuide.serie_invoice ?? ''}
							error={errors.serie_invoice}
							onChange={handleChange}
							name='serie_invoice'
							maxLength={17}
						/>
					...
					<div className='w-full'>
						<TextInput
							...
							value={referralGuide.date_invoice ?? ''}
					...
					<div className='w-full'>
						<TextInput
							type='text'
							label='Autorización'
							value={referralGuide.authorization_invoice ?? ''}
							error={errors.authorization_invoice}
							onChange={handleChange}
							name='authorization_invoice'
							maxLength={49}
						/>
					</div>
				</div>
