            ...
            >
                ...
                <nav className="p-2">
                    <ul className={`${menu ? "transition-all duration-300 [&>li>a>h3]:block" : "[&>li>a>h3]:hidden group-hover:[&>li>a>h3]:block"} [&>li>a>h3]:text-white [&>li>a>svg]:stroke-white`}>
                        ...
                        <li>
                            <Link onClick={handleCloseSidebar}
                                className="rounded hover:bg-primaryhover flex gap-2 px-2 py-2" href='/orders'>
                                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-7 h-7">
                        ...
                        {/* <li>
                            <Link onClick={handleCloseSidebar}
                                className="rounded hover:bg-primaryhover flex gap-2 px-2 py-2" href='/ventas'>
                                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-7 h-7">
                        ...
                        <li>
                            <Link onClick={handleCloseSidebar}
                                className="rounded hover:bg-primaryhover flex gap-2 px-2 py-2" href='/customers'>
                                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-7 h-7">
                        ...
                        <li>
                            <Link onClick={handleCloseSidebar}
                                className="rounded hover:bg-primaryhover flex gap-2 px-2 py-2" href='/reports'>
                                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-7 h-7">
